...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($kode_jurusan) && !empty($nama_jurusan)) {
        ...
        $stmt = mysqli_prepare($koneksi, "INSERT INTO jurusan (kode_jurusan, nama_jurusan) VALUES (?, ?)");
        ...
        if ($sukses) {
            ...
            $status_message = "Gagal menambahkan jurusan: " . mysqli_error($koneksi);
            $alert_type = 'danger';
        }
    } else {
        $status_message = "Kode dan Nama Jurusan wajib diisi.";
        $alert_type = 'warning';
    }
}
?>
